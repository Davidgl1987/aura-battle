    ...
    <div className="screen screen--rivals" style={{ '--who': rival.look.color } as React.CSSProperties}>
          ...
          {RIVALS.map((r) => {
            ...
            return (
              <button
                ...
                aria-label={open ? r.name : `${r.name}, locked`}
              >
      ...
      <div className="rivals__sheet">
        <div className="rival__id">
          ...
          <span className="rival__dots" aria-label={`Difficulty ${rival.difficulty} of 5`}>
            {[1, 2, 3, 4, 5].map((n) => (
        ...
        {unlocked ? (
          <>
            ...
            <p className="rival__signature">
              Plays <strong>{signature.emoji} {signature.name}</strong> · yours if you win
            </p>
            <button
          ...
          <div className="rival__locked">
            <p>Beat {blockedBy?.name} to get here.</p>
